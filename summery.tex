...
\documentclass[openany,hebrew,ctexart,dvipsnames,beamer]{book}
\usepackage{titletoc}
%\documentclass{cej}
\usepackage{fontspec}
...
\usetikzlibrary{snakes,arrows,automata,arrows.meta}
...
\usepackage{color,xfrac,pdfpages,soul}
...
\colorlet{RED}{red}
\definecolor{OliveGreen}{cmyk}{0.64,0,0.95,0.40}
\usepackage{array,dcolumn,pgf,calc,makecell}
...
\iffalse The following part has been moved into Newtestmenst 
\appendix
\begin{appendices}
