...
\usepackage{pgfplots}
\usepackage{pgfplotstable,float,wrapfig,lipsum,booktabs}
%\pgfplotsset{
...
%\include{CBeiLuFiles/YL_malaji}%王上
%\include{CBeiLuFiles/YL_hagaishu}%王下
%\include{CBeiLuFiles/YL_sajialiya1}
%\include{CBeiLuFiles/finalSummery}%代上
