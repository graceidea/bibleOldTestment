...
\usetikzlibrary{calc,trees,automata,positioning,decorations.pathreplacing,shapes}
\tikzset{
>=stealth',
  punktchain/.style={
    rectangle, 
...
\include{ZongJie/bibleChildren/chapter1Creation}
\include{ZongJie/bibleChildren/chapter2CreationOfMan}
\include{ZongJie/bibleChildren/chapter3Sin}
\include{ZongJie/bibleChildren/chapter4Flood}
\include{ZongJie/bibleChildren/chapter5Abraham}
\include{ZongJie/bibleChildren/chapter6Moses}
\include{ZongJie/bibleChildren/chapter7David}
\include{ZongJie/bibleChildren/new1JesusBirth}
\include{ZongJie/bibleChildren/new2Biptism}
\include{ZongJie/bibleChildren/new3SinnerNLove}
\include{ZongJie/bibleChildren/new4Miracles_HealParalytic}%医治四人抬瘫子
\include{ZongJie/bibleChildren/new4Miracles_stopSeaStorm}
\include{ZongJie/bibleChildren/new5Characters}
\include{ZongJie/bibleChildren/new6Kingdom}
\include{ZongJie/bibleChildren/new7Death}
\include{ZongJie/bibleChildren/new8Resrection}
\include{ZongJie/bibleChildren/new9Return}
%\include{ZongJie/childrenbible/new}
\end{document}
