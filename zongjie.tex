...
\include{ZongJie/AChuangShiJiZongJie}
%\include{ZongJie/AZongJieChuangShiJi}
\include{ZongJie/AChuAiJi}%
\include{ZongJie/ALiWeiJi}%
\include{ZongJie/BLiShiShuZongJie}%
\include{ZongJie/CBeiLuGuiHui}%
\include{ZongJie/EShiPian}%
\include{ZongJie/DXianZhiZongJie1}
\include{ZongJie/DYeLiMiZongJieVerses}
\include{ZongJie/DYeLiMiZongJie}
\include{ZongJie/DYiXiJie}
\include{ZongJie/DDanYiLiZongJie}
\include{ZongJie/DYaShu}
\include{ZongJie/DBaBiLun}
\include{ZongJie/DMoYa}
\include{ZongJie/DXianZhiZongJie}
\include{ZongJie/DXianZhiShuMingCi}%
\include{ZongJie/Dtemp}%代上
%==========================XianZhiZongJie

\appendix
\begin{appendices}
\include{ZongJie/SoulBody}%
\include{ZongJie/DOuXiang}
\include{ZongJie/Fasting}
%\input{ZongJie/DiMingRenMing/DiMing}% moved to new testment zongjie
%\input{ZongJie/DiMingRenMing/RenMing}% moved to new testment zongjie
\end{appendices}
