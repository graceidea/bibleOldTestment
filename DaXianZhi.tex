...
\include{DXianZhiFiles/YiSaiYa} 
\include{DXianZhiFiles/YeLiMi}
\include{DXianZhiFiles/YeLiMiAiGe}    

\include{DXianZhiFiles/YiXiJie} 

\include{DXianZhiFiles/DanYiLi} 
\include{DXianZhiFiles/HeXiA} 
\include{DXianZhiFiles/Jeol} 
\include{DXianZhiFiles/AMoSiShu}
\include{DXianZhiFiles/EBaDiYa}
\include{DXianZhiFiles/YueNa}
\include{DXianZhiFiles/MiJia}
\include{DXianZhiFiles/NaHong}
\include{DXianZhiFiles/HaBaGu}
\include{DXianZhiFiles/XiFanYa}
\include{DXianZhiFiles/YL_hagaishu}
\include{DXianZhiFiles/YL_sajialiya1}
\include{DXianZhiFiles/YL_malaji}


%\include{DXianZhiFiles/XianZhiZongJie1}
%\include{DXianZhiFiles/XianZhiZongJie}
%\include{DXianZhiFiles/temp}%代上
